  ...
  return (
    <>
      <div
        ...
        onMouseEnter={() => handleMouseEnterBig("BaatCheet")}
        onMouseLeave={handleMouseLeave}
      >
        <div className='image-3 w-full h-full bg-white p-6'>
        <div className='w-full h-full flex items-center'>
            <img src={cardData[2].image} alt={cardData[2].title} className="w-full object-contain object-center border border-white p-2" />
          </div>
        </div>
